...
const staticMoviesIDs = [];
const STATIC_MOVIES_COUNT = 20;
...
const getUniqueIdForStaticMovies = getUniqueIdFactory();

for (let i = 0; i < STATIC_MOVIES_COUNT; i++) {
  staticMoviesIDs.push(getUniqueIdForStaticMovies());
}
